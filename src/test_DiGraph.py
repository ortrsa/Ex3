...
class TestDiGraph(TestCase):
    ...
    def test_add_edge(self):
        self.assertFalse(Galgo.G.add_edge(0,1,Galgo.G.edges[0][1].w),"this edge already exist->should be False")
        ...
        self.assertEqual(3,Galgo.G.edges[0][1].w,"edge should weight 3 after we changed it")
        self.assertEqual(1, Galgo.G.edges[7][1].w, "edge should weight 1 after adding it")
